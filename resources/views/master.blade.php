      ...
      <div class="container position-relative d-flex align-items-center justify-content-end">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li>
                <a href="{{ route('profile') }}" class="btn btn-primary rounded-circle" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; margin-right: 50px">
